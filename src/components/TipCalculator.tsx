...
function TipCalculator({
  ...
  return (
    <div className="tip_section">
      ...
      <div className="tip_category">
        <label htmlFor="custom_tip">Select Tip %</label>
        <div>
          <input type="button" value="5%" onClick={handleButtonClick} />
          <input type="button" value="10%" onClick={handleButtonClick} />
          <input type="button" value="15%" onClick={handleButtonClick} />
          <input type="button" value="25%" onClick={handleButtonClick} />
          <input type="button" value="50%" onClick={handleButtonClick} />
          <input
            type="number"
            inputMode="numeric"
            name="custom_tip"
